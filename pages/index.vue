          ...
          <div class="menu__slick">
            ...
            <div class="menu__slide">
              <a href="#" class="menu__item menu__item_sports">
                <div class="menu__icon">
                  <img src="@/assets/img/menu/icon-6.png" alt="">
                </div>
          ...
          <div class="promo__wrap">
            ...
            <div class="promo__slick">
              <div class="promo__slide">
                <div class="promo__item flex-center">
                  <div class="promo__bg img-cover">
                    <img src="@/assets/img/promo/bg-2.jpg" alt="">
                  </div>
              ...
              <div class="promo__slide">
                <div class="promo__item flex-center">
                  <div class="promo__bg img-cover">
                    <img src="@/assets/img/promo/bg.jpg" alt="">
                  </div>
                      ...
                      <div class="filter__bottom-wrap flex bottom delay-6">
                        ...
                        <div class="filter__sort flex">
                          <div class="filter__sort-caption flex">
                            <img src="@/assets/img/filter/sort-icon.svg" alt="">
                            <span>Sort by</span>
                          </div>
                ...
                <div class="catalog__coll">
                  ...
                  <div class="catalog__items">
                    ...
                    <a href="#" class="catalog__item project--js flex bottom ">
                      <div class="catalog__left">
                        <div class="catalog__img img-cover">
                          <img src="@/assets/img/catalog/img-1.jpg" alt="">
                        </div>
                        <div class="catalog__verified flex">
                          <div class="catalog__verified-icon img-contain">
                            <img src="@/assets/img/catalog/verified-icon.svg" alt="">
                          </div>
                      ...
                      <div class="catalog__right">
                        <div class="catalog__top flex">
                          ...
                          <div class="star star_good flex">
                            <img src="@/assets/img/catalog/star.svg" alt="">
                            <span>9.0</span>
                          </div>
                        </div>
                    ...
                    <a href="#" class="catalog__item project--js flex bottom ">
                      <div class="catalog__left">
                        <div class="catalog__img img-cover">
                          <img src="@/assets/img/catalog/img-5.jpg" alt="">
                        </div>
                        <div class="catalog__verified flex">
                          <div class="catalog__verified-icon img-contain">
                            <img src="@/assets/img/catalog/verified-icon.svg" alt="">
                    ...
                    <a href="#" class="catalog__item project--js flex bottom ">
                      <div class="catalog__left">
                        <div class="catalog__img img-cover">
                          <img src="@/assets/img/catalog/img-2.jpg" alt="">
                        </div>
                        <div class="catalog__left-box">
                          <div class="catalog__left-info active">
                            <div class="catalog__left-info__name">Active</div>
                    ...
                    <a href="#" class="catalog__item project--js flex bottom ">
                      <div class="catalog__left">
                        <div class="catalog__img img-cover">
                          <img src="@/assets/img/catalog/img-6.jpg" alt="">
                        </div>
                        <div class="catalog__verified flex">
                          <div class="catalog__verified-icon img-contain">
                            <img src="@/assets/img/catalog/verified-icon.svg" alt="">
